...
func (x *StreamFinished) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
func (x *StreamFinished) GetHlsUrl() string {
	if x != nil {
		return x.HlsUrl
	}
	return ""
...
func (x *StreamFinished) GetSourceType() string {
	if x != nil {
		return x.SourceType
	}
	return ""
...
var file_api_proto_rawDesc = []byte{
	...
	0x62, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x46, 0x69, 0x6e,
	...
	0x08, 0x46, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x48, 0x6c, 0x73,
	0x55, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x48, 0x6c, 0x73, 0x55, 0x72,
	...
	0x77, 0x0a, 0x09, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x12, 0x2e, 0x0a, 0x0d,
	...
	0x61, 0x70, 0x69, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x14,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x46, 0x69, 0x6e, 0x69,
	0x73, 0x68, 0x65, 0x64, 0x12, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x1a, 0x0b, 0x2e, 0x61, 0x70, 0x69, 0x2e,
...
var file_api_proto_depIdxs = []int32{
	4, // 0: api.StreamRequest.Start:type_name -> google.protobuf.Timestamp
	4, // 1: api.StreamRequest.End:type_name -> google.protobuf.Timestamp
	0, // 2: api.Stream.RequestStream:input_type -> api.StreamRequest
	2, // 3: api.Heartbeat.SendHeartBeat:input_type -> api.HeartBeat
	3, // 4: api.Heartbeat.NotifyStreamFinished:input_type -> api.StreamFinished
	1, // 5: api.Stream.RequestStream:output_type -> api.Status
	1, // 6: api.Heartbeat.SendHeartBeat:output_type -> api.Status
	1, // 7: api.Heartbeat.NotifyStreamFinished:output_type -> api.Status
